...
//Huge thanks to gbl08ma these time functions are borrowed from utilities
...
int gettimeofday(struct timeval *tv, struct timezone *tz){
	tv->tv_usec=0;//caiso prizm RTC does not have that much precision don't even bother
